defmodule Dictio.Notion.Api do
  @default_base_url "https://api.notion.com/v1"
  @default_api_version "2021-05-13"
  alias Dictio.Notion.{Response, ListResponse}
  ...
  * `:base_url` - API base url, defaults to "https://api.notion.com/v1"
  ...
  defp configured_key(), do: Application.get_env(:dictio, :api_key)

  defp set_base_url(opts) do
    Map.put(opts, :base_url, configured_base_url() || default_base_url())
  end

  defp configured_base_url(), do: Application.get_env(:dictio, :base_url)
  ...
  defp configured_api_version(), do: Application.get_env(:dictio, :api_version)
